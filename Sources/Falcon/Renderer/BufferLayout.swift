...
public struct BufferLayout {
    ...
    public enum Builder {
        ...
        typealias Expression = ShaderPrimitive

        /// The type of a partial result, which will be carried through all of the
        /// build methods.
        typealias Component = [ShaderPrimitive]

        /// The type of the final returned result.
        typealias FinalResult = (elements: [Element], stride: Int)
        ...
        /// statement blocks.
        static func buildBlock(_ firstChild: Component, _ children: Component...) -> Component {
